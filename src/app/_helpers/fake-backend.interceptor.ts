...
export class FakeBackendInterceptor implements HttpInterceptor {
    userTestStatus : User[] = [
        new User({ id: 1, firstName: 'Sergi', lastName: 'Redorta', email:'sergi.redorta@hotmail.com', password: 'Secure0', mobile: '0623133212', isLoggedIn:false, isValidated: true, role: 'secretaire', groups:["member","admin"], avatar:'url(data:image/png;base64,)'}),
        ...
        new User({ id: 9, firstName: 'Ser0', lastName: 'Red0', email:'ser0@red.com', password: 'Secure0', mobile: '0611223344', isLoggedIn:false, isValidated: true, role:'member', groups:["member"], avatar:'url(data:image/png;base64,)'}),
        new User({ id: 10, firstName: 'Ser1', lastName: 'Red1', email:'ser1@red1.com', password: 'Secure0', mobile: '0611223344', isLoggedIn:false, isValidated: true, role:'member', groups:["member"], avatar:'url(data:image/png;base64,)'}),
        new User({ id: 11, firstName: 'Ser2', lastName: 'Red2', email:'ser2@red2.com', password: 'Secure0', mobile: '0611223344', isLoggedIn:false, isValidated: true, role:'member', groups:["member"], avatar:'url(data:image/png;base64,)'}),
        ...
        return of(null).pipe(mergeMap(() => {
            ...
            if (request.url.endsWith('/users/list') && request.method === 'POST') {
                ...
                if (request.body.role === "member") {
                    users = this.userTestStatus.filter(i => i.role === "member");
                    return of(new HttpResponse({ status: 200, body: users }));  //Return the user data
                }  
