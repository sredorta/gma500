...
export class FakeBackendInterceptor implements HttpInterceptor {
    userTestStatus: { id: number, firstName: string,lastName:string,email:string,mobile:string,password:string,isValidated:boolean ,role:string, groups:string[], avatar:string}[] = [
        ...
        { id: 4, firstName: 'Christine', lastName: 'besson', email:'christine.besson@hotmail.com', password: 'Secure0', mobile: '0623133212', isValidated: true, role: 'bureau', groups:["member","admin"], avatar:'url(data:image/png;base64,)'},
        { id: 5, firstName: 'Ben', lastName: 'Vignot', email:'ben.vignot@hotmail.com', password: 'Secure0', mobile: '0611223344', isValidated: true, role:'bureau', groups:["member"], avatar:'url(data:image/png;base64,)'},
        { id: 6, firstName: 'Sophie', lastName: 'Larribeau', email:'sophie@hotmail.com', password: 'Secure0', mobile: '0611223344', isValidated: true, role:'bureau', groups:["member","admin","kk"], avatar:'url(./assets/img/user-default.jpg)'},
        { id: 7, firstName: 'Anne', lastName: 'Forestier', email:'annef@hotmail.com', password: 'Secure0', mobile: '0623133212', isValidated: true, role: 'vice-président', groups:["member","admin"], avatar:'url(data:image/png;base64,)'},
        { id: 8, firstName: 'Francois', lastName: 'Force', email:'f.force@hotmail.com', password: 'Secure0', mobile: '0611223344', isValidated: true, role:'trésorier', groups:["member"], avatar:'url(data:image/png;base64,)'},
