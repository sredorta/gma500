/*export const environment = {
  production: true,
  apiURL: '/php',
  MIN_INIT_WAITING_DELAY: 3000,            //Minimum delay the la page loading initial (Config load)
...
export const environment = {
  production: true,
  apiURL: 'https://www.ecube-solutions.com/gma500laravel/public/api',
  storageURL : 'https://www.ecube-solutions.com/gma500laravel/public/storage/',
